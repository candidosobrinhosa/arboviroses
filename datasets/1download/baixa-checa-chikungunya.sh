...
# -------------------------------------------------------------------------
# Baixar arquivos CSV do SINAN/Chikungunya (2015–2025)
# -------------------------------------------------------------------------

OUTDIR="./dados_chikungunya"
CSVDIR="${OUTDIR}/csv"
LOGFILE="${OUTDIR}/log_chikungunya.txt"

mkdir -p "$OUTDIR" "$CSVDIR"

BASE_URL="https://s3.sa-east-1.amazonaws.com/ckan.saude.gov.br/SINAN/Chikungunya/csv"
ANO_INICIAL=2015
ANO_FINAL=2025
